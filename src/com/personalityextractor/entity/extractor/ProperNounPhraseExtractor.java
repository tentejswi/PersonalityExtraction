...
public class ProperNounPhraseExtractor implements IEntityExtractor {
...
//				.initialize("/home/semanticvoid/PE/PersonalityExtraction/lair/englishPCFG.ser.gz");
		...
		IEntityExtractor e = new ProperNounPhraseExtractor();
		List<String> sentences = Arrays.asList(
				"I have been working on an Android SDK for the Nuxeo Content Management Platform in the past months"
